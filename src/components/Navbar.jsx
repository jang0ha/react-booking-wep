...
const BookIcon = () => (
  ...
  >
    <g clip-path="url(#clip0_4285_390)">
      <path
        d="M15.8336 4.16667V5.83333H12.5002V4.16667H15.8336ZM7.50024 4.16667V9.16667H4.16691V4.16667H7.50024ZM15.8336 10.8333V15.8333H12.5002V10.8333H15.8336ZM7.50024 14.1667V15.8333H4.16691V14.1667H7.50024ZM17.5002 2.5H10.8336V7.5H17.5002V2.5ZM9.16691 2.5H2.50024V10.8333H9.16691V2.5ZM17.5002 9.16667H10.8336V17.5H17.5002V9.16667ZM9.16691 12.5H2.50024V17.5H9.16691V12.5Z"
        fill="#4C88FF"
      />
    </g>
    <defs>
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-4">
        <button>
          <svg
            className={`h-6 w-6 cursor-pointer text-white transition-all duration-500 ${isScrolled ? "invert" : ""}`}
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
